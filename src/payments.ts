...
export const PAYMENT_METHODS: { id: PaymentMethod; brand: "visa" | "mastercard" | "amex" | "discover"; label: string; behaviour: string }[] = [
  { id: "card_ok", brand: "visa", label: "Visa ···4242", behaviour: "always succeeds" },
  { id: "card_decline_then_ok", brand: "mastercard", label: "Mastercard ···0341", behaviour: "declines twice, succeeds on the third attempt" },
  { id: "card_insufficient_funds", brand: "amex", label: "Amex ···9995", behaviour: "insufficient funds until attempt 4" },
  { id: "card_decline", brand: "discover", label: "Discover ···0002", behaviour: "always declines" },
];
